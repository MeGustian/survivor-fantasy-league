			...
			case 'boolean':
				return (
					React.createElement("div", {className: "btn-group btn-group-lg", role: "group"}, 
						React.createElement("button", {type: "button", className: "btn btn-success" + isSelected}, "Yes"), 
						React.createElement("button", {type: "button", className: "btn btn-danger", isSelected: true}, "No")
					)
				);
			case 'contestant':
				return (
					React.createElement("div", {className: "btn-group btn-group-lg", role: "group"}, 
						...
						React.createElement("ul", {className: "dropdown-menu"}, 
							React.createElement("li", null, React.createElement("a", null, "Dropdown link")), 
							React.createElement("li", null, React.createElement("a", null, "Dropdown link"))
						)
					)
				)
