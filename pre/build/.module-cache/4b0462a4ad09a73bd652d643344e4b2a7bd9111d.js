	...
	render: function () {
		return (
			...
			React.createElement("div", {className: "thumbnail", style: {minHeight: '210px'}}, 
				React.createElement("div", {className: "row"}, React.createElement("img", {className: "img-rounded pull-left", style: {marginRight: '10px'}, src: "/images/contestants/" + this.props.name + ".jpg", alt: this.props.name}), 
