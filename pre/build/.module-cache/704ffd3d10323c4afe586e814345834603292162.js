	...
	render: function () {
		return (
			...
			React.createElement("div", {className: "thumbnail", style: {minHeight: '210px'}}, 
				React.createElement("div", null, React.createElement("img", {className: "img-rounded pull-left", style: {marginRight: '10px'}, src: "/images/contestants/" + this.props.name + ".jpg", alt: this.props.name}), 
				React.createElement("h3", null, this.props.name)), 
				React.createElement("ul", {className: "list-group clearfix"}, 
