		...
		return (
			React.createElement("div", {className: "dropdown"}, 
				...
				React.createElement("ul", {className: "dropdown-menu", "aria-labelledby": "dropdownWeek"}, 
					React.createElement("li", {onclick: this.handleClick(i), key: 1}, React.createElement("a", {href: "#"}, "1")), 
					React.createElement("li", {onclick: this.handleClick(i), key: 2}, React.createElement("a", {href: "#"}, "2")), 
					React.createElement("li", {onclick: this.handleClick(i), key: 3}, React.createElement("a", {href: "#"}, "3"))
				)
			)
		);
	}
