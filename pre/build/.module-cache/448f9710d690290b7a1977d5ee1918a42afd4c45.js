...
var LogIn = require('../components/LogIn'); // Explain...
...
var Fantasy = React.createClass({displayName: "Fantasy",
	render: function () {
		...
		if (!p.user.userId) {
			return React.createElement(SignIn, {submit: function (username, password) {
				return dispatch(act.signIn(username, password));
			}})
		}
		return (
