		...
		return (
			...
			React.createElement(Bs.Col, {sm: 12, md: 4}, 
				React.createElement("img", {
					...
					style: {marginRight: '10px', marginLeft: '10px', width: '200px', height: '200px'}, 
			...
			React.createElement(Bs.Col, {sm: 12, md: 8}, 
				React.createElement("h3", {className: "text-center", style: {margin: '5px'}}, 
					this.props.votedOut ? React.createElement("span", {className: "label label-success label-as-badge"}, "\"voted out\"") : "", 
					this.props.name, 
