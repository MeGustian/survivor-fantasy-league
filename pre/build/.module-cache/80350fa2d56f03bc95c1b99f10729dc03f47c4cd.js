...
var Question = React.createClass({displayName: "Question",
	...
	answerContestants: function () {
		return this.props.contestants.map(function (contestant) {
			return (
				React.createElement("li", {onClick: this.changeAnswer.bind(this, contestant.get('name'))}, React.createElement("a", null, 
					contestant.get('name')
				))
			);
		})
	...
	changeAnswer: function (answer, e) {
		var changable = this.props.user.get('isAdmin') && this.props.details.get('isEditing');
		if (changable) this.setState({answer: answer});
	}
});
