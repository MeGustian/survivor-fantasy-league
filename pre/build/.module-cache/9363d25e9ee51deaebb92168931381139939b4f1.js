		...
		if (isEditing) {
			return (
				React.createElement("div", {className: "toolbox-container"}, 
					React.createElement(AdminToolbox, {tool: "edit", handleClick: this.props.editQuestion}), 
					React.createElement(AdminToolbox, {tool: "remove", handleClick: this.props.removeQuestion})
				)
			);
		}
	}
