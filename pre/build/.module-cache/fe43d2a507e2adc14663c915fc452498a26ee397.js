	...
	render: function () {
		return (
			...
			React.createElement(Bs.Col, {sm: 12, md: 8}, 
				React.createElement("h3", {className: "text-center", style: {marginRight: '5px', marginLeft: '30px'}}, 
					this.props.votedOut ? React.createElement("span", {className: "badge progress-bar-danger"}, "voted out") : "", 
					this.props.name, 
