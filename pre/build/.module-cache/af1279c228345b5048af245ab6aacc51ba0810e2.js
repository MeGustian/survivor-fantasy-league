				...
				React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
					...
					React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
						...
						React.createElement("ul", {className: "dropdown-menu"}, 
							React.createElement("li", {onClick: this.setState.bind(this, {type: 'bool'})}, React.createElement("a", null, "Boolean")), 
							React.createElement("li", {onClick: this.setState.bind(this, {type: 'contestant'})}, React.createElement("a", null, "Contestant"))
						)
					)
				)
			);
