			...
			React.createElement(Bs.Row, null, 
				...
				React.createElement("div", null, 
					...
					React.createElement(Bs.Alert, {pullRight: true, bsStyle: "warning"}, 
						React.createElement("strong", null, "Notice:"), " Submitting choices is permanent! Make sure the selected contestants are the ones you wish to choose.", 
						React.createElement(Bs.Button, {onClick: this.submit}, "Submit your choices")
					), 
