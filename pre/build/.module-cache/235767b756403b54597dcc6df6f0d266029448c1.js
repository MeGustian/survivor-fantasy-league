...
var Question = React.createClass({displayName: "Question",
	...
	questionRender: function () {
		console.log(this.props.details.get('isEditing'));
		if (!this.props.details.get('isEditing')) {
			return this.props.details.get('question')
		} else {
			return (
			...
			return (
				React.createElement("div", {className: "toolbox-container"}, 
					React.createElement(AdminToolbox, {
						tool: "edit", 
						handleClick: handlers.edit.bind(null, questionId, details.get('isEditing'))}
					), 
					React.createElement(AdminToolbox, {
						tool: "remove", 
