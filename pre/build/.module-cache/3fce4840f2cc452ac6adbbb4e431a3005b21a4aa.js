...
var AdminAchievements = React.createClass({displayName: "AdminAchievements",
	render: function () {
		console.info('AdminAchievements');
		return (
		...
		return React.addons.createFragment(
			that.props.contestants
				...
				.map(function (contestant, id) {
					...
					var hasAchieved = contestant.getIn(['weeks', that.props.weekNumber, 'achievements']).get(achievementCode);
					console.log('mapB');
					return (
