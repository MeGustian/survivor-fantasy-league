		...
		return (
			React.createElement("div", {className: "dropdown"}, 
				...
				React.createElement("ul", {className: "dropdown-menu", "aria-labelledby": "dropdownWeek"}, 
					React.createElement("li", {onclick: that.handleClick(i), key: i}, React.createElement("a", {href: "#"}, "1")), 
					React.createElement("li", {onclick: that.handleClick(i), key: i}, React.createElement("a", {href: "#"}, "2")), 
					React.createElement("li", {onclick: that.handleClick(i), key: i}, React.createElement("a", {href: "#"}, "3"))
				)
			)
		);
	}
