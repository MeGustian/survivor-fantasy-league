		...
		return (
			React.createElement("div", {className: "dropdown"}, 
				...
				React.createElement("ul", {className: "dropdown-menu", "aria-labelledby": "dropdownWeek"}, 
					React.createElement("li", {onClick: this.handleClick(1), key: 1}, React.createElement("a", {href: "#"}, "1")), 
					React.createElement("li", {onClick: this.handleClick(2), key: 2}, React.createElement("a", {href: "#"}, "2")), 
					React.createElement("li", {onClick: this.handleClick(3), key: 3}, React.createElement("a", {href: "#"}, "3"))
				)
			)
		);
	}
