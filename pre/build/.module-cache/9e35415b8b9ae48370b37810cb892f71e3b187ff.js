				...
				React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
					...
					React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
						...
						React.createElement("ul", {className: "dropdown-menu"}, 
							React.createElement("li", {onClick: this.setState.bind(null, {type: 'bool'})}, React.createElement("a", null, "Boolean")), 
							React.createElement("li", {onClick: this.setState.bind(null, {type: 'contestant'})}, React.createElement("a", null, "Contestant"))
						)
					)
				)
			);
