		...
		if (this.props.tool === 'add') {
			return (
				React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
					React.createElement("button", {type: "button", className: "btn btn-default btn-lg", onClick: this.props.handleClick.bind(null, this.state.type)}, 
					...
					React.createElement("div", {className: "btn-group", role: "group", "aria-label": "..."}, 
						...
						React.createElement("ul", {className: "dropdown-menu"}, 
							React.createElement("li", {onClick: this.chooseType.bind(this, 'boolean')}, React.createElement("a", null, "boolean")), 
