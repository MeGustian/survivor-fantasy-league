...
var Question = React.createClass({displayName: "Question",
	...
	tools: function () {
		...
		var isEditing = this.props.details.isEditing;
		...
		if (isEditing) {
			return (
				React.createElement("div", {className: "toolbox-container"}, 
					React.createElement(AdminToolbox, {
						tool: "edit", 
						handleClick: handlers.edit.bind(null, details.questionId, isEditing)}
					), 
					React.createElement(AdminToolbox, {
						tool: "remove", 
						handleClick: handlers.remove.bind(null, details.questionId)}
					)
				)
			);
		} else {
			return (
				...
				React.createElement(AdminToolbox, {
					tool: "approve", 
					handleClick: handlers.update.bind(null, details.questionId, details.question, details.answer, details.type)}
				)
				)
			);
		}
