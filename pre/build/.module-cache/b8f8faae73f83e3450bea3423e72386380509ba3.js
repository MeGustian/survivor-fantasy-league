		...
		switch (details.get('type')) {
			...
			return (
				React.createElement("div", {className: "btn-group btn-group-lg", role: "group"}, 
					React.createElement("button", {type: "button", className: "btn btn-success", active: answer, onClick: this.changeAnswer.bind(this, true)}, "Yes"), 
					React.createElement("button", {type: "button", className: "btn btn-danger", active: !answer, onClick: this.changeAnswer.bind(this, false)}, "No")
				)
			);
			case 'contestant':
			var nobody = !answer ? " active" : "";
			var Ans = AnswerTypes.Contestants;
			return (
				React.createElement(Ans, {
